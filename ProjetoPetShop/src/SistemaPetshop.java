...
public class SistemaPetshop {
    ...
    public void menuGerenciamento(int respostaDoMenuPrincipal) {
        int resposta;
    ...
    public void menuAdotante(int respostaDoMenuPrincipal) {
        int resposta;
    ...
    public void logicaSistema(int respostaDoMenuPrincipal) {
        switch (respostaDoMenuPrincipal) {
            case 1: {
                menuGerenciamento(respostaDoMenuPrincipal);
                break;
            }

            case 2: {
                menuAdotante(respostaDoMenuPrincipal);
                break;
            }
            case 3: {
